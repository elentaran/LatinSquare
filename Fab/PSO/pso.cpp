...
#define MIROIR
			...
			for (short d=valeur1; d<valeur2; d++)
			{
				temp = ind1.hypercube[d][probaMutationDim];
				ind1.hypercube[d][probaMutationDim] = ind1.hypercube[valeur2][probaMutationDim];
